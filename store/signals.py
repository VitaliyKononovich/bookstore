...
# When the sender Cart sends post_save signal this function will run
@receiver(post_save, sender=Cart)
def adjust_stock(sender, instance, **kwargs):   # instance in our case will be Cart
    if not instance.active:
        ...
        # subject = 'Tanks for shopping with Mystary Books!'
